...
-- NOTE: Neovim settings  (see `:help vim.o`)
...
-- NOTE: Plugins and packer setup 
local ensure_packer = function()
-- Automatically install and setup packer and plugins 
  local fn = vim.fn
...
require('packer').startup(function(use)
  ...
  use { -- Keyword highlighting (TODO, NOTE etc)
  ...
  use { -- Pretty list for diagnostics, LSP stuff and errors 
    "folke/trouble.nvim",
    requires = "nvim-tree/nvim-web-devicons",
    config = function()
  ...
  use 'luisiacc/gruvbox-baby' -- NOTE: use #141617 as background_dark in .local/share/nvim/site/pack/packer/start/gruvbox-baby
  ...
  use 'ap/vim-css-color' -- Colored background for hex 
...
-- NOTE: Setups, locals, and other fun stuff 
...
local servers = { 'clangd', 'rust_analyzer', 'pyright', 'lua_ls', 'gopls' }
...
cmp.setup {
  formatting = { -- Enables icons from table above
